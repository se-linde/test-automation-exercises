...
public class PopupDialogTest {
  ...
  public void chap6test1() {
    ...
    // Old, with the page out of bounds error. 
    ...
    */ 
    ...
    // New - with a CC expiry year that's in the past. 
    // 49 | select | id=cc_exp_year | label=2014 | 
    {
      WebElement dropdown = driver.findElement(By.id("cc_exp_year"));
    ...
    driver.findElement(By.cssSelector("#cc_exp_year > option:nth-child(06)")).click();
